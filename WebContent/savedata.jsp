...
<title>Saving Expense Data</title>
</head>
...
<body>
	...
	<%
			...
			if (actual_users == 0) {
	%>
	<jsp:include page="insert_successful.jsp"></jsp:include>
	<%
		} else {
				boolean saved = false;
				...
				if (save) {
					...
					while (get_user_set.next()) {
						...
						while (chk_set.next()) {
							...
							{
							%>
							<jsp:include page="insert_successful.jsp"/>
							<%}else{ %>
							<jsp:include page="Insert_failure.jsp"></jsp:include>
